    ...
    if request.method == 'POST':
        ...
        try:
            product = Product(
                ...
                price_idr=float(request.form['price']) * 15000,  # Assuming 1 USD = 15000 IDR
...
def edit_product(product_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            product.price_usd = float(request.form['price'])
            product.price_idr = float(request.form['price']) * 15000
